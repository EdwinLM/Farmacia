...
#SECRET_KEY = 'django-insecure-5#s#+i3n6f3652vtt1bif09_ga^u5sj$$j@heii=vk#-m_@#8_'
...
#STATICFILES_DIRS = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'static', 'media')
