    ...
    tblSale = $('#myTable').DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                orderable: false,
                render: function (data, type, row) {
                    var buttons = '<a href="/erp/sale/delete/' + row.id_compra + '/" class="btn btn-danger btn-xs btn-flat"><i class="fas fa-trash-alt"></i></a> ';
                    ...
                    buttons += '<a href="/erp/sale/invoice/pdf/'+row.id_compra+'/" target="_blank" class="btn btn-info btn-xs btn-flat"><i class="fas fa-file-pdf"></i></a> ';
                    return buttons;
                }
            },
        ],
